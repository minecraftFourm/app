...
const USERNAME_PATTERN = /^[a-z](?!.*?[^\na-z0-9]{2}).*?[a-z0-9]{6,32}$/; // Minimum 7 characters, cannot start with a word, or special characters, also cannot end with a special character. Maximum length is 32 characters.



module.exports = { EMAIL_PATTERN, PASSWORD_PATTERN, USERNAME_PATTERN };