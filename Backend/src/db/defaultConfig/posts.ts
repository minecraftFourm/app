...
const posts = async () => {
	const announcement1 = await prisma.post.upsert({
		where: { id: "64b2c0f3-e725-4f7d-aeba-c44fe955ec1e" },
		update: {},
		create: {
			id: "64b2c0f3-e725-4f7d-aeba-c44fe955ec1e",
	...
	const announcement2 = await prisma.post.upsert({
		where: { id: "b82139b5-9aff-40f2-b370-1978f385e9f2" },
		update: {},
		create: {
			id: "b82139b5-9aff-40f2-b370-1978f385e9f2",
