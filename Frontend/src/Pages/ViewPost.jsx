        ...
        <div className="bg-white h-fit mx-6 md:mx-2 sm:mx-0 sm:px-2 mt-16 p-4">
          <div className="w-full h-fit outline outline-1 outline-gray-400 pb-4">
            ...
            <div className="px-2 flex flex-row gap-2 mx-1 mt-4 min-h-[500px]">
              <div className="max-w-[300px] w-full pb-2 outline outline-1 outline-gray-400">
                <div className="mb-4 h-full">
                    ...
                    <div className="w-full h-fit flex flex-col flex-wrap items-center justify-center mt-2">
                      <p className="text-3xl font-bold capitalize">{post.owner.username}</p>
                      
                      <div>
                        <p style={{ backgroundColor: post.owner.role.color}} className="text-sm text-white font-bold rounded-sm border-[1px] px-2 outline-indigo-700">{post.owner.role.title.toUpperCase()}</p>
                      </div>
              ...
              <div className="w-full px-2 py-2 outline outline-1 flex flex-col justify-between outline-gray-400 bg-gray-100">
              <div
                className="pb-4"
